            ...
            modelBuilder.Entity("CoreBankingTest.CORE.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateOpened = new DateTime(2025, 10, 14, 3, 37, 24, 812, DateTimeKind.Utc).AddTicks(3561),
                            IsActive = true,
                            IsDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("CoreBankingTest.CORE.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CustomerId = new Guid("a1b2c3d4-1234-5678-9abc-123456789abc"),
                            DateCreated = new DateTime(2025, 10, 4, 3, 37, 24, 812, DateTimeKind.Utc).AddTicks(3297),
